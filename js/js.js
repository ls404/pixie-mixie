...
$("#show-grid").on("click", function () {
    ...
    $("#drawing-canvas").toggleClass("has-border");
    $("#drawing-canvas").find(">tr").toggleClass("has-border");
    $("#drawing-canvas>tr>td").toggleClass("has-border");
});
...
$("#colors-grid").on('mousedown', (".colorbg"), function (event) {
    let bgColor = $(this).css('backgroundColor');
    if (event.buttons == 1) {
        // drawCell(this);
        characteristics.color = bgColor;
        drawCell("#cursor");
    } else if (event.buttons == 2) {
        // eraseCell(this);
        // table.css
        characteristics.bgColor = bgColor;
        drawCell("#cursor");
...
// Functions for drawing cells(pixels) in table
...
let drawCell = function (thisCell) {
    ...
    if (characteristics.formatArray[0] === "formatted") {
        ...
        if (characteristics.formatArrayId === "format0") {
...
let generateGrid = function (gridX, gridY) {
    ...
    // If three rows below enabled, initial styling of grid is with border.
    // $("#drawing-canvas").toggleClass("has-border");
    // $("#drawing-canvas>tr").toggleClass("has-border");
    // $("#drawing-canvas>tr>td").toggleClass("has-border");
